...
const ART={
  PG:"/assets/pig-green-v4.svg",
  PB:"/assets/pig-blue-v4.svg",
  TAPE:"/assets/tape-v4.svg",
  TOOL:"/assets/toolbox-v4.svg",
  HAT:"/assets/hardhat-v4.svg",
  SAW:"/assets/saw-v4.svg",
  WILD:"/assets/wolf-v4.svg"
};
...
function boot(){
  try{
    ...
    window.__qa={
      ...
      stop:()=>quickStop(),
      wheel:()=>startWheel([]),
      feature:(type="free")=>startFeature(type,positions(state.grid,"HAT")),
